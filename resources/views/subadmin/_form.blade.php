...
<!-- <input type="url" name="sponserid" placeholder="Referral URL" value="{{isset($user->sponserid)?$user->sponserid: ''}}" <?php if(isset($user->sponserid)){?> readonly <?php }?>class="form-control" >-->

<!--      @if ($errors->has('sponserid')) <p class="help-block text-danger">{{ $errors->first('sponserid') }}</p> @endif -->
<!--    </div>-->
...
<label>Mobile Number <span class="text-danger">*</span></label>   
      <input type="text" class="form-control numbersOnly" maxlength="10" name="phone_no" id="phone_no" placeholder=" " value="{{isset($user->phone_no)?$user->phone_no:''}}"  required > 
