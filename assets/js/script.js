...
const spinValues = [
  ...
  { minDegree: 211, maxDegree: 270, value: 25 },
...
const generateValue = (angleValue) => {
  for (let i of spinValues) {
    if (angleValue >= i.minDegree && angleValue <= i.maxDegree) {
      text.innerHTML = `<h3>Congratulations, You Have Won Rs.${i.value} ! </h3>`;
...
spinBtn.addEventListener("click", () => {
  ...
  text.innerHTML = `<h3>Best Of Luck!</h3>`;
